...
// const Body = ({darkMode, changeTheme, initialVal}) => {
//   const color = useContext(ThemeContext);
//   const theme = darkMode? color.dark: color.light;
  
//   return(
//       <main className={`flex h-[80vh]`}>
//           <div className={`flex flex-col w-[90vw] sm:w-[400px] bg-[${theme.background}] text-[${theme.foreground}] rounded-2xl transition duration-500`}>
...
//                   <Screen initialVal={initialVal} darkMode={darkMode} />
//               </div>
//               <div className={`flex h-[47vh] md:h-[47vh] bg-[${theme.bgButtons}] rounded-2xl transition duration-500 text-[${theme.foreground}] p-4`}>
//                   <Buttons darkMode={darkMode} initialVal={initialVal} />
//               </div>
//           </div>
//       </main>
//   )
...
const App = () => {
  ...
  // }
  // const color = darkMode? themeContext.dark : themeContext.light
